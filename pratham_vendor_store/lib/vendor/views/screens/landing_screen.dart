...
import 'package:pratham_vendor_store/vendor/models/vendor_user_models.dart';
import 'package:pratham_vendor_store/vendor/views/auth/vendor_register_screen.dart';
        ...
        return Center(
          child: Column(
            ...
            children: [
              ...
              Text(
                'Your application hass been sent to Admin\n Admin will get back to you.',
                style: TextStyle(
                  fontSize: 22,
